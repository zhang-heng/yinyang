...
namespace yinyang{
	...
	private:
		...
		long _invoker_id;
		CallbackFunction(std::string name, long l_address, int argn);
		long call_fun(long __1 = 0, long __2 = 0, long __3 = 0, long __4 = 0, long __5 = 0,
			long __6 = 0, long __7 = 0, long __8 = 0, long __9 = 0);
		void creat_handler(std::vector<FunArg*> args);

		/*static*/
	public:
		static void init_callbacks();
		static CallbackFunction* creat_callback_funciton(std::vector<std::vector<char>> args);
	private:  
		static std::map<std::string, CallbackFunction*> _callbacks;
		static bool inited;
	}; 
}